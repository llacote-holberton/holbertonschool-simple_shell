...
We take robustness and memory management seriously. Code has been examined with Valgrind to ensure zero memory leaks, and compared against standard /bin/sh.
