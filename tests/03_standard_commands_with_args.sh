...
run_test "Test 3.6: 'mkdir ./tempfolder' (creates dir)" "mkdir ./tempfolder"
run_test "Test 3.7: 'cp ./tests_files/file_to_copy.txt ./tempfolder/copied_file.txt'" "cp ./tests_files/file_to_copy.txt ./tempfolder/copied_file.txt"
run_test "Test 3.8: 'rm ./tempfolder/copied_file.txt'" "rm ./tempfolder/copied_file.txt"
run_test "Test 3.9: 'rmdir ./tempfolder/' (removes folder)" "rmdir ./tempfolder/"